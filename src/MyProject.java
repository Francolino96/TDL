...
public class MyProject {
    ...
    public void printCommitment(TDLElement el) {
    ...
    public int searchCommitment(ArrayList<TDLElement> myTDL, String title) {
    ...
    public String homePage(ArrayList<TDLElement> myTDL) {
        System.out.println("\n\nYOUR TO DO LIST \n");
        if (myTDL.isEmpty())
            System.out.println(" The list is empty\n");
        for (TDLElement tdlElement : myTDL) {
    ...
    public void insertTitleCategoryOrText(TDLElement commitment, String element) {
        ...
        switch (element) {
            ...
            case "category" -> commitment.setCategory(element_input);
            case "text" -> commitment.setText(element_input);
        }
    }

    public void insertPriority(TDLElement commitment) {
        String userInput;
        String priority = "";
        do {
    ...
    public void modifyCommitment(ArrayList<TDLElement> myTDL) {
        System.out.println("\nMODIFY A COMMITMENT");
        String userInput;
        ...
        if (elementPosition == -1) System.out.println("Error. A commitment with that title does not exist");
            ...
            if (choice.equals("y")) {
                ...
                if (choice.equals("y"))
                    insertTitleCategoryOrText(myTDL.get(elementPosition), "title");
                choice = makeAChoice("Do you want to modify the category?");
                if (choice.equals("y"))
                    insertTitleCategoryOrText(myTDL.get(elementPosition), "category");
                ...
                if (choice.equals("y"))
                    insertTitleCategoryOrText(myTDL.get(elementPosition), "text");
            } else
                System.out.println("The commitment has not been modified.");
        }
    }

    public void createNewCommitment(ArrayList<TDLElement> myTDL) {
        System.out.println("\nCREATE A NEW COMMITMENT");
        TDLElement newElement = new TDLElement();
        insertTitleCategoryOrText(newElement, "title");
        insertTitleCategoryOrText(newElement, "category");
        insertPriority(newElement);
        insertTitleCategoryOrText(newElement, "text");
        System.out.println("Your new commitment:\n");
        printCommitment(newElement);
        myTDL.add(newElement);
    }

    public void deleteCommitment(ArrayList<TDLElement> myTDL) {
        System.out.println("\nDELETE A COMMITMENT");
        String userInput;
